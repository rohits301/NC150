class Solution {
    ...
    // S: O(m+n)
    /*
     * 1. When multiplying two numbers, the result is maximum the sum of length of both numbers.
     ...
     * NOTE: edge case is when any of the strings is "0", our code without the if check
     * will return an empty string as number except zeros in the array, so handle separately.
     */
