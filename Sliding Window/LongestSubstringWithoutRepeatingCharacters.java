...
class Solution {
     ...
     * 6. It has inner loop, yet the complexity is linear, because every element is accessed only twice. Once while adding to the set, other time while removing it from the set.
     */
    public int lengthOfLongestSubstring(String s) {
        int maxLength = 0;
        int left = 0, right = 0;
